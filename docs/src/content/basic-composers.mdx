...
There are several basic composers `stylings` provides.
...
> [!note]
>
> `$color` and `$frame` are described in more detail in [Colors](./colors.mdx) and [Frames](./frames.mdx) sections.

This page explains the basic composers and their capabilities. 
